<?php /* C:\xampp\htdocs\acme\resources\view/includes/admin-sidebar.blade.php */ ?>
 <div class="off-canvas position-left reveal-for-large nav" id="offCanvas" data-off-canvas>
 		...
 		<div class="image-holder text-center">
 			...
 			<img src="<?php echo e(aurl('/images/avatar.png')); ?>" alt="terry" title="admin">
 			<p>Terry 0.</p>
 		</div>
	    ...
	    <ul class="vertical menu">
	      ...
	      <li><a href="manage_inventory"> <i class="fa fa-edit fa-fw"></i>&nbsp; Manage Product </a></li>
